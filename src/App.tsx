...
import { NovelCrawler } from './components/NovelCrawler';
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/crawler" element={<AppContent />} />
    </Routes>
  );
}
...
function AppContent() {
  ...
  const isCrawlerPage = location.pathname === '/crawler';
  ...
  const handleOpenCrawler = useCallback(() => {
    navigate('/crawler');
  }, [navigate]);
  ...
  return (
    ...
    >
      ...
      <Sidebar
        ...
        onOpenCrawler={handleOpenCrawler}
      />
